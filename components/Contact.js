...
const confetti = {
  light: {
    primary: "E8E3FF", // blue.400
    secondary: "E8E3FF", // blue.100
  },

  dark: {
    primary: "9374ff", // blue.900
    secondary: "B9A2FF", // blue.800
  },
};
...
export default function ContactFormWithSocialButtons() {
  ...
  return (
    <Flex
      bg={useColorModeValue("#F9FBFD", "#1A202C")}
      align="center"
      justify="center"
      css={{
        ...
        <Box>
          <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
            ...
            >
              ...
              <Box
                as="form"
                action={process.env.FORMSPARK} // Replace with your Formspree endpoint URL
                method="POST"
              ...
              >
                <VStack spacing={5}>
                  ...
                  <Button
                    ...
                    type="submit" // Add type="submit" to the button to make it a submit button
                    isFullWidth
                  >
                    Send Message
                  </Button>
